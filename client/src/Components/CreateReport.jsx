...
const CreateReport = () => {
    ...
    const handleGenerateReport = async () => {
        try {
            ...
            const userName = getLoggedInUserName(); // Get the logged-in user's name
    ...
    const getLoggedInUserName = () => {
        ...
        return userData ? `${userData.firstName} ${userData.lastName}` : 'N/A'; // Adjust according to how you store user data
    };    
