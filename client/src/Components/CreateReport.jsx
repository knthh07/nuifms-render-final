...
const CreateReport = () => {
    ...
    const handleGenerateReport = async () => {
        try {
            ...
            const logo = await import('../assets/img/nu_logo.png');
            ...
            doc.text(`Department: ${department || 'N/A'}`, 10, 100);
            doc.text(`Building: ${building || 'N/A'}`, 10, 110);
            doc.text(`Campus: ${campus || 'N/A'}`, 10, 120);
